...
- [0004 — URL-Owned Page Size](0004-pagination-page-size.md): makes inventory page size URL-owned and user-selectable (25 / 50 / 100, default 50, default omitted from the URL, changing it resets page to 1), superseding the fixed page-size clauses in the System Design and UI System Design.
