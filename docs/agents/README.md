...
- **Antigravity Builder** — implementation and repair. Builders are the normal source-code writers.
...
- **Codex Compliance** — fresh final audit of the complete product against the System Design. It is the only agent role allowed to declare release PASS.
